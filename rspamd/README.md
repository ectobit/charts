...
![Version: 0.13.1](https://img.shields.io/badge/Version-0.13.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 4.0.1-alpine3.24.1](https://img.shields.io/badge/AppVersion-4.0.1--alpine3.24.1-informational?style=flat-square)
...
When `externalRedis.existingSecret` is set, the password is read from that Secret through the `REDIS_PASSWORD` environment variable and the generated Redis config is mounted from a Kubernetes Secret instead of the chart ConfigMap. TLS CA/client files are mounted only when `externalRedis.tls.enabled=true` and `externalRedis.tls.existingSecret` is set.
...
| externalRedis.existingSecret            | string | `""`                                                                                                                                                                                                                                                                                                                       | Existing Secret containing the Redis password. The password is exposed to Rspamd through REDIS_PASSWORD.               |
