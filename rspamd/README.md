...
![Version: 0.13.2](https://img.shields.io/badge/Version-0.13.2-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 4.0.1-alpine3.24.1](https://img.shields.io/badge/AppVersion-4.0.1--alpine3.24.1-informational?style=flat-square)
...
| redis.auth.enabled                      | bool   | `false`                                                                                                                                                                                                                                                                                                                    | Enable Redis password authentication. Keep disabled unless Rspamd Redis password configuration is provided separately.                                                  |
